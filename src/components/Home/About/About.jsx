      ...
      <div className="container mx-auto py-20">
        ...
        <div className=" p-[50px] rounded-md glass grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className=" ml-4">
            ...
            <p className=" border-[3px] w-44 font-medium border-[#1d72b8] text-center px-10 py-3 rounded">
              About Us
            </p>

            <h1 className="text-5xl   flex flex-col my-5">
            ...
            <p className="text-[#4C4C4C] font-[24px] ">
